...
DECLARE @DBName nvarchar(100)='OCM_Staging'
...
BACKUP DATABASE [OCM_Staging] TO  DISK = N'C:\Temp\Data Backups\OCM_Clone.bak' WITH NOFORMAT, INIT,  NAME = N'OCM_Clone Backup', SKIP, NOREWIND, NOUNLOAD,  STATS = 10
...
RESTORE VERIFYONLY FROM  DISK = N'C:\Temp\Data Backups\OCM_Clone.bak' WITH  FILE = @backupSetId,  NOUNLOAD,  NOREWIND
GO
